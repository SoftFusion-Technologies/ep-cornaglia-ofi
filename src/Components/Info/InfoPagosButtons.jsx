...
const InfoPagosButtons = () => {
    return (
      <div className="flex flex-wrap justify-center gap-6 mb-12">
        ...
        <a
          href="https://api.whatsapp.com/send/?phone=%2B5493865239239&text=Hola%2C+me+gustar%C3%ADa+gestionar+mi+cuenta+para+el+Portal.%0ANombre+completo%3A+%28completar%29%0ADNI%3A+%28completar%29&type=phone_number&app_absent=0"
          target="_blank"
          rel="noopener noreferrer"
