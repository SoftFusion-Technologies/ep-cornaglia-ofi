  ...
  return (
    <div className="container mx-auto p-10 max-w-full overflow-hidden">
      ...
      <div className="bg-white p-10 mt-8 rounded-lg border border-gray-200">
        ...
        <div className="mb-4">
          <p className="text-gray-600">
            <strong>Dirección:</strong> Sarmiento 48
          </p>
          <p className="text-gray-600">
            <strong className=" mr-1">Horarios de Atención:</strong>
            <span className="block md:inline mr-2">
              Lun a Vie: 08:00 a 13:00 / 17:00 a 21:00
            </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-300 hover:shadow-lg transition-shadow duration-300">
            <p className="text-gray-600 space-y-2">
              ...
              <span className="flex items-center">
                <a
                  href={`https://wa.me/5493865239239`}
                  className="flex items-center"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <WhatsAppLink number="+5493865239239" />
                  3865-239239
                </a>
              </span>
              <span className="flex items-center">
      ...
      <div className="bg-white p-10 mt-8 rounded-lg border border-gray-200">
        ...
        <div className="mb-4">
          <p className="text-gray-600">
            <strong>Dirección:</strong> Av. San Martín 270
          </p>
