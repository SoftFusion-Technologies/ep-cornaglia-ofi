...
const Main = () => {
  return (
    ...
    >
      {/* Se agrega animación de entrada */}
      <div className="md:w-1/2 w-full text-center md:text-left animate__animated animate__fadeIn animate__delay-300ms">
      ...
      {/* Se agrega animación de entrada con transformaciones */}
